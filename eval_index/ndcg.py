...
def ndcg(rel_true, rel_pred, p=None, form="exponential"):
    ...
    # 因为索引是从0开始的，正常应该加1，但是从0开始，log(0+1)则等于无穷大，
    # 所以这里面加的是2，如果索引是从1开始，则加的是1，所以感觉跟上面的公式不一致，其实是一样的。
...
print("【ndcg.py】ndcg([1, 2, 3, 4], [4,3, 2, 1], 4)=",ndcg([1, 2, 3, 4], [4,3, 2, 1], 4))
