...
def get_data_by_repo_name(repo_name):
    ...
    print("【FIFO.py】len(data)=",len(data))  ##查看PR数量
...
def fifo_result(true_rate_label_dict, day_data, repo_name):
    ...
    for day in day_data.keys():
        ...
        print("【FIFO.py】=================================日期:", day)
        print("【FIFO.py】fifo pr_number排序:", fifo_data)
        print("【FIFO.py】fifo_sort:", fifo_sort)
        print("【FIFO.py】true_sort:", true_sort)
        print("【FIFO.py】ndcg_num:", ndcg_num)
        print("【FIFO.py】mrr_num:", mrr_num)
        print("【FIFO.py】kendall_num:", kendall_num)
    ...
    for i in range(len(day_list)):
        ...
        row_data.append(tmp)
    print("【FIFO.py】row_data=",row_data)
    # 保存数据到csv文件
...
if __name__ == '__main__':
    repo_name =get_repo_name()#"scikit-learn"#"moby"#"cocos2d-x"#"netbeans"#"yii2"#"dubbo"#"react"#"tensorflow"#"opencv"#"phoenix"#"helix"#"terraform"#"Ipython"#"kuma"# "incubator-heron"
