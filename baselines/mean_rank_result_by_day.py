...
if __name__ == '__main__':
    repo_name = get_repo_name()#"moby"#"cocos2d-x"#"netbeans"#"Katello"#"dubbo"#"tensorflow"#"opencv"#"terraform"#"phoenix"#"helix"#"Ipython"#"kuma"#"incubator-heron"#"zipkin"#"Katello"
    file_path_tmp = []
    alg_dict = {
        0: "Random_Forests"
    }
