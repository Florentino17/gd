...
def text_save(all_filename, train_filename, test_filename, data):  # filename为写入CSV文件的路径，data为要写入数据列表.
    ...
    train_file.close()
    test_file.close()
    print("【rank_lib_data_process.py】保存文件成功")
...
def get_data_by_repo_name(repo_name):
    ...
    print("【rank_lib_data_process.py】len(raw_data)=",len(raw_data))  ##查看PR数量
    ...
    print("【rank_lib_data_process.py】count=",count)
    ...
    # 如果最大值和最小值相等，则差值为0，则除数为0，会报错，所以需要处理
    for i in range(len(ranges)):
        if ranges[i] == 0:
            ranges[i] = 1    
    print("【rank_lib_data_process.py】ranges=",ranges)
...
if __name__ == '__main__':
    repo_name =get_repo_name()#"scikit-learn"#"moby"#"cocos2d-x"#"netbeans"#"yii2"#"dubbo"#"react"#"tensorflow"#"opencv"#"phoenix"#"helix"#"terraform"#"Ipython"# "kuma"#"incubator-heron"#"kuma"#"incubator-heron"#"Katello"#"zipkin"#"yii2"
